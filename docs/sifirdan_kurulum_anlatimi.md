...
Router’ınızın web arayüzünde, internet hizmeti aldığınız bağlantıya göre **İNTERNET / Ethernet Kablosu (veya DSL)** girin. **İSS Kimlik Doğrulama (PPPoE / PPTP / L2TP) / Gelişmiş PPPoE ayarlarını göster**’de İSP'den gelen DNSv4 yoksay’ı, IPv6 kullanıyorsanız aynı şekilde DNSv6 yoksay’ı işaretleyip kaydedin.
...
Bu aşamada dikkat etmeniz gereken nokta kurulum yapılacak **cihazın işlemci mimarisine göre** OPKG Entware paket yöneticisi kurmanızdır.
...
Uygulamada ilgili alana router’ınızın web arayüzüne ulaşmak için kullandığınız IP adresini girin; genelde **192.168.1.1**’dir. Port olarak duruma göre **22 veya 222** girin.
...
(Uyarı: Password yazılırken yazı gözükmez, ekran tepkisizdir.)

- Varsayılan **keenetic** parolasını değiştirmek için:
...
### Yöntem 1 (pratik):
PuTTY / Termius’daki komut satırına aşağıdaki komutu yazıp onaylayın.
...
İşlem tamamlandıktan sonra kurulu betiği:
...
yazarak kullanmaya başlayabilirsiniz.

---

### Yöntem 2 (klasik):
DH'den @Revolution_TR -gps.navigation- un geliştirdiği Keenetic router’lar için özelleştirilmiş Zapret betiğini githup linkinden indirin.
...
---
Derleyen ve Hazırlayan: @tayaydin (https://forum.donanimhaber.com/profil/1731649)
